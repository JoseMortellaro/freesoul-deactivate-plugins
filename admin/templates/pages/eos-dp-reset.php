...
function eos_dp_reset_settings_callback() {
	...
	$args        = array(
		'reset'              => array(
			'type'        => 'checkbox',
			'description' => esc_html__( 'I want to reset all the settings of FDP. I am aware that this action is irreversible.', 'freesoul-deactivate-plugins' ),
		),
	...
	$description = '<p>' . esc_html__( 'All the settings will be completely cleared. Do this only if you are completely sure, and after making a full backup.', 'freesoul-deactivate-plugins' ) . '</p>';
