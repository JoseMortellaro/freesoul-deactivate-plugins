...
// Callback for keeping active a certain plugin only when specific URLs are matched.
function eos_dp_one_place_callback() {
	add_action(
		...
		<p><?php esc_html_e( 'If you use these settings for a specific plugin, then that plugin will be deactivated everywhere but will be active when the specified URLs are matched.', 'freesoul-deactivate-plugins' ); ?></p>
			<?php
		}
	);
