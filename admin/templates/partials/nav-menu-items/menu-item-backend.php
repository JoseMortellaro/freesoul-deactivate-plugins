...
<li data-section="eos-dp-edit-by-post-type" class="hover eos-dp-setts-menu-item"><a href="<?php echo esc_url( admin_url( 'admin.php?page=eos_dp_admin_by_post_type' ) ); ?>"><?php esc_html_e( 'Edit by Post Type', 'freesoul-deactivate-plugins' ); ?></a></li>
<?php } ?>
